...
void EventDisplay::drawParticles()
{
...
void EventDisplay::drawEvent(int event)
{
  ...
  // draw the various event elements
  drawParticles();
  drawHits();
  drawDigis();
  drawTracks();
